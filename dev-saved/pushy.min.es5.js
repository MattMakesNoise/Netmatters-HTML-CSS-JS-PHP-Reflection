...
!function (a) {
  ...
  var g = a(".pushy"),
      ...
      p = g.width() + "px",
      q = ".pushy-submenu",
      r = "pushy-submenu-open",
      s = "pushy-submenu-closed";
  if ("undefined" != typeof g.data("menu-btn-selector")) var t = g.data("menu-btn-selector");else var t = ".menu-btn";
  var u = a(t + ", .pushy-link"),
      v = a(t),
      w = "#container";
